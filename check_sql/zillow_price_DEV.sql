...
SELECT * FROM eventlogs.event_zillowaction where RunID = '15415' and SeverityID > 2 order by 1 desc;
SELECT * FROM eventlogs.event_zillowpriceaction where RunID = '15415' and SeverityID > 2 order by 1 desc;
