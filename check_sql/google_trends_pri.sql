...
SELECT * FROM great_wall.google_trends_interest_over_time 
#where search_string_id = '91' 
order by 1 desc;



SELECT * FROM great_wall.google_trends_interest_over_time where rundate = '2019-11-22 10:33:11' and  search_string_id = '91' order by 1 desc;
...
SELECT count(1), rundate FROM great_wall.google_trends_interest_over_time  group by rundate desc;


SELECT count(1), count(distinct search_string_id),  rundate FROM great_wall.google_trends_interest_over_time group by rundate desc;
