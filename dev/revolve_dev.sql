...
select * from eventlogs.event_revolveaction where JobID = '7124002' order by 1 desc;

select * from eventlogs.event_revolveaction where RunID = '11376' order by 1 desc;
select * from eventlogs.event_revolveaction where RunID = '11376' and SeverityID > 2 order by 1 desc;
